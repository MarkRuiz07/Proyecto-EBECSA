...
CONSTRAINT Prospecto_Cedula UNIQUE (cedula,correoElectronico,TelefonoP),
);
...
NumeroPasajeros int,
NumeroCirculacion int,
idProspecto int,
idseguros int,
idcategoria int,
CONSTRAINT nombreCirculacion_modelo UNIQUE (NumeroCirculacion,modelo),
